...
namespace PropertyToolTip.Composers
{
    public class PropertyToolTipApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Property Tool Tip Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<PropertyToolTipOperationSecurityFilter>();
            });
        }

        public class PropertyToolTipOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("PropertyToolTip.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
